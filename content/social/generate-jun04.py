#!/usr/bin/env python3
"""Jun 04 — What Each Sign Avoids Saying Out Loud (EI style, plum bg, circular engravings)."""
...
OUT_TIKTOK   = os.path.expanduser("~/.openclaw/workspace/signseason/content/social/slides-2026-06-04-tiktok")
OUT_IG       = os.path.expanduser("~/.openclaw/workspace/signseason/content/social/slides-2026-06-04-instagram")
...
SIGNS = [
    ("aries",       "♈", "aries-ram",    "Aries",
     "\"i might be wrong.\"\naries will circle the sun\ntwice before admitting\nthey missed something."),
    ("taurus",      "♉", "taurus",       "Taurus",
     "\"i'm scared of losing this.\"\ntaurus holds tighter\ninstead. you'll feel it\nbut never hear it."),
    ("gemini",      "♊", "gemini",       "Gemini",
     "\"i don't actually know.\"\ngemini will talk around\nthe uncertainty\nfor hours rather than say it."),
    ("cancer",      "♋", "cancer",       "Cancer",
     "\"i need more\nthan i'm asking for.\"\ncancer gives generously\nso no one sees the deficit."),
    ("leo",         "♌", "leo",          "Leo",
     "\"i care what you\nthink of me.\"\nleo performs confidence\nuntil it becomes real."),
    ("virgo",       "♍", "virgo",        "Virgo",
     "\"i can't fix this one.\"\nvirgo will keep trying\nlong after they know\nit's beyond their reach."),
    ("libra",       "♎", "libra",        "Libra",
     "\"i've already decided.\"\nlibra asks for your opinion\nafter the choice is made.\nthey just want the peace."),
    ("scorpio",     "♏", "scorpio",      "Scorpio",
     "\"i trust you.\"\nscorpio will show you\neverything except\nthose three words."),
    ("sagittarius", "♐", "sagittarius",  "Sagittarius",
     "\"i'm not okay.\"\nsagittarius books a flight\ninstead. motion is\neasier than admission."),
    ("capricorn",   "♑", "capricorn",    "Capricorn",
     "\"i'm exhausted.\"\ncapricorn would rather\nwork harder than ask\nsomeone to help carry it."),
    ("aquarius",    "♒", "aquarius",     "Aquarius",
     "\"i'm lonely.\"\naquarius will philosophize\nabout human connection\nwhile standing outside it."),
    ("pisces",      "♓", "pisces",       "Pisces",
     "\"i knew this\nwould happen.\"\npisces absorbs the ending\nlong before it arrives.\nand says nothing."),
]

TITLE_LINES = ["what each sign avoids", "saying out loud"]
TITLE_SUB   = "gemini season. say the thing."
...
def make_outro_slide(w, h, tex):
    ...
    lines = ["which one are you", "avoiding?"]
    y = int(h * 0.38)
    for line in lines:
...
if __name__ == "__main__":
    generate(OUT_TIKTOK, 1080, 1920)
    generate(OUT_IG, 1080, 1350)
    print("\nAll done.")
