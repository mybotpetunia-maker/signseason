    ...
    <tr><td align="center" style="padding:40px 16px;">
      <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;">
        ...
        <tr><td style="border:1px solid rgba(201,173,111,0.25);padding:48px 32px;background-color:#2A1F33;">
          ...
          <p style="font-family:-apple-system,Helvetica,Arial,sans-serif;font-size:11px;color:#6B6058;margin:8px 0 0;text-align:center;">Sign Season, 6688 Nolensville Rd, Ste 108 #2223, Brentwood, TN 37027</p>
